...
if __name__ == '__main__':
    ...
    # temp_ckpt = "./pretrained/released/tempaligner_49_downloaded.pt"
    # semantic_ckpt = "./pretrained/released/semanticaligner_49"
    # videosummarizer_ckpt = "./results/sutd-traffic/ckpt/videosummarizer_49.pt"
    ############################################################################
    ...
    loaded_videosum = torch.load(videosummarizer_ckpt, map_location='cpu') 
    tempaligner.video_summarizer.load_state_dict(loaded_videosum['state_dict'])
